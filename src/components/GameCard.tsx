...
const GameCard = ({ title, description, icon: Icon, path, gradient }: GameCardProps) => {
  return (
    <Link to={path} className="group">
      <Card className="overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[var(--shadow-game)] bg-background/20 backdrop-blur-sm ">
        <CardContent className="p-8">
          ...
          <h3 className="text-2xl font-bold mb-3 text-text-mainpage/80">{title}</h3>
