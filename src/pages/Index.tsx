...
const Index = () => {
  const games = [
    ...
    {
      title: "Tic Tac Toe",
      description: "Strategic three-in-a-row challenge!",
      icon: Grid3x3,
      path: "/tic-tac-toe",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
      {/* Hero Section */}
      <div 
        className="relative h-[400px] bg-cover bg-center flex items-center justify-center mb-16 overflow-hidden"
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-xl md:text-2xl text-foreground/80 max-w-2xl mx-auto animate-fade-in">
            Choose your game and challenge yourself!
          </p>
        </div>
      </div>
